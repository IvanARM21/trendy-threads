...
export const ProfileSidebar = ({
  ...
  return (
    <div
      className={twMerge(
        "min-w-52 py-8 bg-zinc-100 shadow z-30 absolute invisible md:visible md:opacity-100 opacity-0 md:relative -translate-x-full md:translate-x-0 h-[60vh] rounded-l-xl transition-all duration-300",
