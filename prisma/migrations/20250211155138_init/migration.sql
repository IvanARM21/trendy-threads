...
-- CreateEnum
CREATE TYPE "OrderPaymentStatus" AS ENUM ('ERROR', 'PENDING', 'PAYED', 'REJECTED', 'CANCELLED', 'IN_PROCESS', 'AWAITING_PAYMENT', 'REFUNDED', 'CHARGED_BACK', 'UNKNOWN');

-- CreateEnum
CREATE TYPE "FulfillmentStatus" AS ENUM ('RECEIVED', 'CONFIRMED', 'PROCESSING', 'TO_SHIP', 'SHIPPED', 'DELIVERED', 'READY_FOR_PICKUP', 'PICKED_UP', 'FAILED_DELIVERY', 'RETURNED');
...
CREATE TABLE "Order" (
    ...
    "fulfillmentStatus" "FulfillmentStatus" NOT NULL DEFAULT 'RECEIVED',
